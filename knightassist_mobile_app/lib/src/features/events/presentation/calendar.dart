...
DateTime? _selectedDay;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: TableCalendar(focusedDay: _focusedDay, firstDay: DateTime.fromMillisecondsSinceEpoch(1641031200000), lastDay: DateTime.fromMillisecondsSinceEpoch(1767063659000), // currently set to 1 yr before and after 12/29/23
